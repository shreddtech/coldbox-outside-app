	...
	<div class="text-center card shadow-sm bg-light border border-5 border-white">
		<div class="card-body">
			...
			<div class="col-lg-6 mx-auto">
				<p class="lead mb-4">
					<a class="btn btn-primary" href="main/myRoute">Test My Route with Rewrites</a>
					<a class="btn btn-primary" href="index.cfm/main/myRoute">Test My Route without Rewrites</a>
				</p>
			</div>
		</div>
	</div>
